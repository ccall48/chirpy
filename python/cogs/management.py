...
Commands:
    ...
    list            make nunya compute a list
...
class Management(commands.Cog, name='Management'):
    ...
    ##         'say `nunya help` to learn about available commands, '
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            ...
            await ctx.send(
                ...
                f'`nunya help {ctx.command.qualified_name}`'
            )
            return
    ...
    async def unload_extension(self, ctx, extension_name):
        ...
        if target_extension.lower() in 'cogs.management':
            await ctx.send(
                ...
                f"\n+ try nunya reload {target_extension}!```"
            )
            return
